...
namespace Backend.Controllers
{
    ...
    public class CarrerasController : ControllerBase
    {
        ...
        // GET: api/Carrera/deleteds
        [HttpGet("deleteds")]
        public async Task<ActionResult<IEnumerable<Carrera>>> GetDeletedsCarreras()
        {
            return await _context.Carreras.AsNoTracking().IgnoreQueryFilters().Where(a => a.IsDeleted).ToListAsync();
        }
        ...
        {
            var carrera = await _context.Carreras.IgnoreQueryFilters().FirstOrDefaultAsync(a => a.Id.Equals(id));
            if (carrera == null)
            {
                return NotFound();
            }
